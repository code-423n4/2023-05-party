...
contract InitialETHCrowdfundTest is Test, TestUtils, ERC721Receiver {
    ...
    function test_partyCardTokenURI_whileCrowdfundActive() public {
        InitialETHCrowdfund crowdfund = _createCrowdfund(
            CreateCrowdfundArgs({
                initialContribution: 0,
                initialContributor: payable(address(0)),
    ...
    function test_partyCardTokenURI_whileCrowdfundWon() public {
        InitialETHCrowdfund crowdfund = _createCrowdfund(
            CreateCrowdfundArgs({
                initialContribution: 0,
                initialContributor: payable(address(0)),
    ...
    function test_partyCardTokenURI_whileCrowdfundLost() public {
        InitialETHCrowdfund crowdfund = _createCrowdfund(
            CreateCrowdfundArgs({
                initialContribution: 0,
                initialContributor: payable(address(0)),
    ...
    function test_partyCardTokenURI_whileCrowdfundFinalized() public {
        InitialETHCrowdfund crowdfund = _createCrowdfund(
            CreateCrowdfundArgs({
                initialContribution: 0,
                initialContributor: payable(address(0)),
